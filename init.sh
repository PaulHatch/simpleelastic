...
case "$1" in
  ...
  "--integration")
	...
	IMAGE_TAG=${1} docker-compose -f docker-compose.integration.yml run test
  ...
  "--publish")
	...
	git push https://${GITHUB_USER}:${GITHUB_TOKEN}@github.com/PaulHatch/simpleelastic.git master --tags
	;;
