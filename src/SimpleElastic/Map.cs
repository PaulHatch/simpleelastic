...
namespace SimpleElastic
{
    ...
    public class Map : DynamicObject, IEnumerable
    {
        ...
        /// from the <see cref="T:System.Dynamic.DynamicObject" /> class can override this
        /// method to specify dynamic behavior for operations such as setting a value for a property.
        /// </summary>
        ...
        /// value is being assigned. For example, for the statement sampleObject.SampleProperty
        ...
        /// "SampleProperty". The binder.IgnoreCase property specifies whether the member name
        ...
        /// class derived from the <see cref="T:System.Dynamic.DynamicObject" /> class, the
        ...
        /// dynamic operation is performed. For example, for the Console.WriteLine(sampleObject.SampleProperty)
        /// statement, where sampleObject is an instance of the class derived from the 
        /// <see cref="T:System.Dynamic.DynamicObject" /> class, binder.Name returns
        /// "SampleProperty". The binder.IgnoreCase property specifies whether the member name
        /// is case-sensitive.</param>
        /// <param name="result">The result of the get operation. For example, if the
        /// method is called for a property, you can assign the property value to 
        ...
        /// <param name="indexes">The indexes that are used in the operation. For
        /// example, for the sampleObject[3] = 10 operation in C# (sampleObject(3)
        /// = 10 in Visual Basic), where sampleObject is derived from the 
        /// <see cref="T:System.Dynamic.DynamicObject" /> class, <paramref name="indexes[]" />
        /// is equal to 3.</param>
        /// <param name="value">The value to set to the object that has the specified
        /// index. For example, for the sampleObject[3] = 10 operation in C#
        /// (sampleObject(3) = 10 in Visual Basic), where sampleObject is derived from
        /// the <see cref="T:System.Dynamic.DynamicObject" /> class, <paramref name="value" />
        /// is equal to 10.</param>
        /// <returns>
        /// true if the operation is successful; otherwise, false. If this method returns
        /// false, the run-time binder of the language determines the behavior.
        ...
        /// returns false, the run-time binder of the language determines the behavior.
        /// (In most cases, a language-specific run-time exception is thrown.)
        /// </returns>
        ...
        /// Classes derived from the <see cref="T:System.Dynamic.DynamicObject" />
        /// class can override this method to specify dynamic behavior for indexing
        /// operations.
        /// </summary>
        /// <param name="binder">Provides information about the operation.</param>
        /// <param name="indexes">The indexes that are used in the operation. For
        /// example, for the sampleObject[3] operation in C# (sampleObject(3) in
        /// Visual Basic), where sampleObject is derived from the DynamicObject
        /// class, <paramref name="indexes[]" /> is equal to 3.</param>
        ...
        /// <returns>
        /// true if the operation is successful; otherwise, false. If this method returns
        /// false, the run-time binder of the language determines the behavior. (In most cases,
        /// a language-specific run-time exception is thrown.)
        /// </returns>
